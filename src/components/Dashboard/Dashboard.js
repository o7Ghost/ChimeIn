...
class Dashboard extends React.Component {
  ...
  changeCurrentClass(classID,identity) {
    this.setState({
      ...
      <React.Fragment>
        ...
        <div className={classes.root}>
          ...
          >
            ...
            <div className={classes.others}>
                <DropClass change={this.changeCurrentClass} db={firebase} classID={this.state.currentClass} identity={this.state.identity}/>
            </div>
            <div className={classes.others}>
                <CreateClass db={firebase}/>
            </div>
              <div className={classes.others}>
                <AddTA db={firebase} classID={this.state.currentClass} identity={this.state.identity}/>
              </div>
